...
# Appendix D: Latent Class Analysis
 ...
 Additionally to the mixed logit models, we estimate latent class models with two to six classes. 
<details>
...
# Appendix I: Comparision of WTP across all models

<details>
  <summary>Appendix I: Comparision of WTP across all models</summary>

We provide a table that compares mean and median (in case of log-normal cost coeffient in preference space) WTP across all models.
...
kable(lc_av_wtp, digits = 4, caption = "Overview of the WTP values for the different models") %>%
