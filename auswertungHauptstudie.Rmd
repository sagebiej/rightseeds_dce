...
if(t$fixed[["mean_cost"]]) mcost=FALSE else mcost=TRUE
...
htmlreg(l = mixmodelsWTP_tex  ,
        custom.model.names = c("Log-normal price", "Fixed price") ,  caption = "Results from models in preference space as WTP values" , single.row = T  , 
        custom.note = "***p < 0.001; **p < 0.01; *p < 0.05 Standard Errors in Brackets" , center = TRUE, doctype = FALSE )
