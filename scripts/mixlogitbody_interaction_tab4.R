...
fixednames  <- c( "ascwinter" , "EIGENTxOC", "EUBIOx", "BIOVERx", "EIGENTx")  
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[['alt1']] =  -cost*(-a1_x1 +
                          ...
                          EUBIOx * a1_EUBIO * q15 + BIOVERx * a1_BIOVER * q16 + EIGENTx * a1_x4 * q14)
  V[['alt2']] = -cost*(-a2_x1 + 
                        asc+ ascwinter*winter + 
                         EUBIO*a2_EUBIO + BIOVER*a2_BIOVER  + REG*a2_REG + DE*a2_DE  + ESP*a2_ESP  + EIGENT*a2_x4 +EIGENTxOC*a2_x4*oc +
                         EUBIOx * a2_EUBIO * q15 + BIOVERx * a2_BIOVER * q16 + EIGENTx * a2_x4 * q14)  
  V[['alt3']] = 0
