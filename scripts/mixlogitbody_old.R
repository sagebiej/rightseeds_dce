...
randnames  <- c( "EUBIO" , "BIOVER" , "REG", "DE", "ESP" , "EIGENT", "cost"  )  
fixednames  <- c("asc" , "ascwinter" , "EIGENTxOC")  
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V = list()
  V[['alt1']] =  -cost*(-a1_x1 +asc+  ascwinter*winter + EUBIO*a1_EUBIO + BIOVER*a1_BIOVER + REG*a2_REG + DE*a1_DE + ESP*a1_ESP  + EIGENT*a1_x4 +EIGENTxOC*a1_x4*oc)
  V[['alt2']] = -cost*(-a2_x1 + asc+ ascwinter*winter + EUBIO*a2_EUBIO + BIOVER*a2_BIOVER  + REG*a2_REG + DE*a2_DE  + ESP*a2_ESP  + EIGENT*a2_x4 +EIGENTxOC*a2_x4*oc)  
  V[['alt3']] = 0
